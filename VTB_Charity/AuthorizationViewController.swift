...
class AuthorizationViewController: UIViewController {
    ...
    private func validate () {
        ...
        do {
            ...
            let password = try passwordTextField.validateText(validators: [TextLengthValidator(minTextLength: 4, message: "Пароль должен содержать не менее 4 символов и не более 10 символов"), RegularExpressionValidator(pattern: #"^[\wа-яА-Я]+(?: [\wа-яА-Я]+)*$"#, message: "Пароль содержит недопустимые симоволы")])
